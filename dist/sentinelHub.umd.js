(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('xml2js'), require('@turf/area'), require('polygon-clipping'), require('query-string'), require('moment'), require('terraformer-wkt-parser'), require('axios')) :
  typeof define === 'function' && define.amd ? define(['exports', 'xml2js', '@turf/area', 'polygon-clipping', 'query-string', 'moment', 'terraformer-wkt-parser', 'axios'], factory) :
  (factory((global.bundle = {}),global.xml2js,global.area,global.polygonClipping,global.queryString,global.moment,global.WKT,global.axios));
}(this, (function (exports,xml2js,area,polygonClipping,queryString,moment,WKT,axios) { 'use strict';

  area = area && area.hasOwnProperty('default') ? area['default'] : area;
  polygonClipping = polygonClipping && polygonClipping.hasOwnProperty('default') ? polygonClipping['default'] : polygonClipping;
