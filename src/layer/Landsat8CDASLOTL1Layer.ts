import { DATASET_CDAS_L8_LOTL1 } from './dataset';
import { AbstractLandsat8Layer } from './AbstractLandsat8Layer';
import { Link, LinkType } from './const';

export class Landsat8CDASLOTL1Layer extends AbstractLandsat8Layer {
  public readonly dataset = DATASET_CDAS_L8_LOTL1;
