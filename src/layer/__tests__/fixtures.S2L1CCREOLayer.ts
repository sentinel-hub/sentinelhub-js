...
import { LinkType, BBox, CRS_EPSG4326, S2L1CCREOLayer } from '../../index';
    ...
    features: [
      {
        ...
        links: [
          {
            href:
              'https://creodias.sentinel-hub.com/api/v1/catalog/collections/sentinel-2-l1c/items/S2A_MSIL1C_20200823T100031_N0209_R122_T32TQM_20200823T121427',
            rel: 'self',
