import { BBox, CRS_EPSG4326, ApiType, MimeTypes, WmsLayer } from '../../';
...
test('WmsLayer.getMapUrl returns an URL', () => {
  ...
  expect(imageUrl).toBe('https://proba-v-mep.esa.int/applications/geo-viewer/app/geoserver/ows?version=1.1.1&service=WMS&request=GetMap&format=image%2Fjpeg&crs=EPSG%3A4326&layers=PROBAV_S1_TOA_333M&bbox=19%2C20%2C20%2C21&time=2020-01-10T00%3A00%3A00.000Z%2F2020-01-10T23%3A59%3A59.000Z&width=512&height=512&showlogo=false&transparent=true&');
})