...
import {
  ...
  DATASET_CDAS_L8_LOTL1,
  DATASET_CDAS_L9_LOTL1,
  DATASET_CDAS_OTC_L8_LOTL1,
  DATASET_CDAS_OTC_L9_LOTL1,
} from './dataset';
...
import { Landsat8CDASLOTL1Layer } from './Landsat8CDASLOTL1Layer';
import { Landsat9CDASLOTL1Layer } from './Landsat9CDASLOTL1Layer';
export class LayersFactory {
  ...
  */
  ...
  private static readonly LAYER_FROM_DATASET_V3 = {
    ...
    [DATASET_CDAS_L8_LOTL1.id]: Landsat8CDASLOTL1Layer,
    [DATASET_CDAS_OTC_L8_LOTL1.id]: Landsat8CDASLOTL1Layer,
    [DATASET_CDAS_L9_LOTL1.id]: Landsat9CDASLOTL1Layer,
    [DATASET_CDAS_OTC_L9_LOTL1.id]: Landsat9CDASLOTL1Layer,
