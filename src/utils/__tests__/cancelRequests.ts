...
class TestClass {
  ...
  public async resolvedPromise(timeout: number, requestsConfig?: RequestConfiguration): Promise<boolean> {
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
  ...
  @timeoutWrapper(1)
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  public async rejectedPromise(timeout: number, requestsConfig?: RequestConfiguration): Promise<void> {
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    return new Promise((resolve, reject) => {
      setTimeout(() => {
        reject('Test error');
