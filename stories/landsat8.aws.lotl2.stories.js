...
export const getMapURL = () => {
  ...
  const layer = new Landsat8LOTL2Layer({ instanceId, layerId });
...
export const getMapWMSEvalscript = () => {
  ...
  const perform = async () => {
    const layer = new Landsat8LOTL2Layer({
      instanceId,
      layerId,
      evalscript: `
...
export const findDatesUTCSearchIndex = () =>
  createFindDatesUTCStory(
    new Landsat8LOTL2Layer({ instanceId, layerId, maxCloudCoverPercent: 40 }),
    bbox4326,
...
export const stats = () => {
  ...
  const layer = new Landsat8LOTL2Layer({ instanceId, layerId: layerIdNdvi, maxCloudCoverPercent: 100 });
